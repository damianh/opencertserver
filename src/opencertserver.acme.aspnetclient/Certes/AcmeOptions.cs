...
{
    /// <summary>
    /// Gets the profile to use for the ACME client. This is used to determine which ACME server to use.
    /// </summary>
    public string? Profile { get; init; }

    /// <summary>
    /// <para>
    /// Gets the password used to encrypt the private key of the certificate.
    /// </para>
    /// <para>
    /// This is required to be able to export the certificate with the private key,
    /// which is necessary for most use cases.
    /// </para>
    /// <para>
    /// If you do not want to encrypt the private key, set this to an empty string.
    /// </para>
    /// </summary>
