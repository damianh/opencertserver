...
public class TpmHelpers
{
    ...
    public bool IsImplemented(TpmCc commandCode)
    {
        if (ImplementedCommands == null || ImplementedCommands.Length == 0)
        {
            ...
            var totalCommands = Tpm2.GetProperty(Tpm, Pt.TotalCommands);
...
public class PrimaryHelpers
{
    ...
    internal async Task<Tpm2CreatePrimaryResponse> CreatePrimaryRsaAsyncInternal(
        ...
        PcrSelection[] pcrSel)
    {
        var attr = ObjectAttr.Restricted | ObjectAttr.Decrypt
        ...
        var sensCreate = new SensitiveCreate(theUseAuth, []);
...
public class KeyHelpers
{
    ...
    public async Task<Tpm2CreateResponse> CreateRsaSigningAsync(
        ...
        TpmHash policy = null)
    {
        var attr = ObjectAttr.Sign | ObjectAttr.FixedParent | ObjectAttr.FixedTPM | // Non-duplicatable
        ...
        var sensCreate = new SensitiveCreate(useAuth, []);
