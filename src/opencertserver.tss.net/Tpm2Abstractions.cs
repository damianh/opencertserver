...
public partial class Tpm2
{
    ...
    public uint[] GetFirmwareVersionEx()
    {
        ...
        var arr = (caps as TaggedTpmPropertyArray).tpmProperty;
        uint fwV1 = 0, fwV2 = 0;
        uint revision = 0;
        ...
        out uint year, out uint dayOfYear)
    {
        ...
        var manX = GetProperty(tpm, Pt.Manufacturer);
    ...
    public static byte[] GetPcrProperty(Tpm2 tpm, PtPcr prop)
    {
        ...
        var props = (caps as TaggedPcrPropertyArray).pcrProperty;
        if (props.Length == 0)
        {
            return [];
        }
